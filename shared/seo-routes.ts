...
export const seoRoutes: Record<string, RouteSeoDef> = {
  ...
  "/gbp/des-peres-mo/": {
    title: "Des Peres Handyman Services | Home Repairs | Hero Handyman Pro",
    description: "Reliable handyman in Des Peres & West St. Louis County, MO — drywall, doors, decks, carpentry, fixtures & home repairs. Also serving Chesterfield, Ballwin & nearby. Call 800-741-6056.",
    h1: "Handyman Services in Des Peres & West St. Louis County, MO",
