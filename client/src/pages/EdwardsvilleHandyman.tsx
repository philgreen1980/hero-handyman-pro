      ...
      <section className="py-10 px-6 bg-white border-b border-[#e5e7eb]">
        <div className="max-w-[1120px] mx-auto">
          <p className="text-[#374151] text-lg leading-relaxed">
            Edwardsville homeowners often face repair needs caused by seasonal weather, home settling, aging materials, and everyday wear and tear. Hero Handyman Pro provides professional <a href="/handyman-services/" className="text-[#ff5b00] hover:underline font-medium">handyman services</a> — including <a href="/handyman-services/drywall-repair/" className="text-[#ff5b00] hover:underline font-medium">drywall repair</a>, <a href="/handyman-services/deck-repair/" className="text-[#ff5b00] hover:underline font-medium">deck repair</a>, and <a href="/carpentry-services/" className="text-[#ff5b00] hover:underline font-medium">carpentry</a> — designed to keep homes functional, safe, and looking their best throughout the year.
          </p>
        </div>
      </section>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify([
        {
          ...
          "url": "https://www.herohandymanpro.com/drywall-repair-edwardsville-il"
        },
        {
          "@context": "https://schema.org",
          "@type": "Service",
          ...
          "provider": { "@type": "LocalBusiness", "name": "Hero Handyman Pro", "telephone": "+1-800-741-6056" },
          "areaServed": { "@type": "City", "name": "Edwardsville", "addressRegion": "IL" },
          "url": "https://www.herohandymanpro.com/deck-repair-edwardsville-il"
        },
        {
          "@context": "https://schema.org",
          "@type": "Service",
          ...
          "provider": { "@type": "LocalBusiness", "name": "Hero Handyman Pro", "telephone": "+1-800-741-6056" },
          "areaServed": { "@type": "City", "name": "Edwardsville", "addressRegion": "IL" },
          "url": "https://www.herohandymanpro.com/door-installation-edwardsville-il"
        }
      ]) }} />
