...
export default function CollinssvilleHandyman() {
  const whyChooseUs = [
    { icon: Home, text: "Local professionals serving Collinsville families" },
  ...
  const faqs = [
    {
      q: "Do you provide free estimates in Collinsville?",
    ...
    },
    {
      ...
      a: "We frequently have same-day or next-day availability in Collinsville. Contact us and we'll confirm our earliest opening."
    },
    {
  ...
  return (
    <div className="flex flex-col">
      <SEO {...seoConfig.collinsvilleHandyman} />
        ...
        <div className="max-w-[1120px] mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-[#ff5b00] text-xl md:text-2xl font-semibold mb-6">
              Professional, Reliable Home Repairs for Collinsville Homeowners
            </p>
            <p className="text-[#e5e7eb] text-lg md:text-xl max-w-3xl mx-auto mb-8">
              Hero Handyman is your trusted local handyman serving Collinsville, IL. From quick repairs to comprehensive home improvement projects, we deliver professional craftsmanship, transparent pricing, and dependable service every time.
            </p>
          </div>
        ...
        <div className="max-w-[1120px] mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-[#4b5563] text-lg max-w-3xl mx-auto">
              Hero Handyman Pro is built on trust, professionalism, and quality workmanship. Collinsville homeowners choose us because we show up on time, communicate clearly, and treat every home with the care and respect it deserves.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-[#ff5b00] to-[#f97316] rounded-2xl p-8 text-white">
            <p className="text-lg leading-relaxed">
              We proudly serve neighborhoods throughout Collinsville—from downtown to the Gateway Center district, from Horseshoe Lake to New Poag Road developments. If you're in Collinsville, we're already working in your neighborhood.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-[1120px] mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#0b1220]">
              Proudly Serving Collinsville and Surrounding Communities
            </h2>
            <p className="text-[#4b5563] text-lg max-w-3xl mx-auto">
              Whether you're in downtown Collinsville, near the Gateway Center, or in one of the area's growing neighborhoods, Hero Handyman is ready to help with fast, professional home repair services.
            </p>
          </div>
      ...
      <section className="py-16 px-6 bg-gradient-to-br from-[#1f2937] via-[#020617] to-[#020617] text-white">
        <div className="max-w-[1120px] mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Ready to Schedule Handyman Service in Collinsville, IL?
          </h2>
