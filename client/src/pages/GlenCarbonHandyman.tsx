...
export default function GlenCarbonHandyman() {
  ...
  const faqs = [
    {
      q: "Do you provide free estimates in Glen Carbon?",
    ...
    },
    {
      ...
      a: "We frequently have same-day or next-day availability in Glen Carbon. Contact us and we'll confirm our earliest opening."
    },
    {
  ...
  return (
    <div className="flex flex-col">
      <SEO {...seoConfig.glenCarbonHandyman} />
        ...
        <div className="max-w-[1120px] mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-[#e5e7eb] text-lg md:text-xl max-w-3xl mx-auto mb-8">
              Hero Handyman is your trusted local handyman serving Glen Carbon, IL. From quick repairs to comprehensive home improvement projects, we deliver professional craftsmanship, transparent pricing, and dependable service every time.
            </p>
          </div>
        ...
        <div className="max-w-[1120px] mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-[#4b5563] text-lg max-w-3xl mx-auto">
              Hero Handyman Pro is built on trust, professionalism, and quality workmanship. Glen Carbon homeowners choose us because we show up on time, communicate clearly, and treat every home with the care and respect it deserves.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-[#ff5b00] to-[#f97316] rounded-2xl p-8 text-white">
            <p className="text-lg leading-relaxed">
              We proudly serve neighborhoods throughout Glen Carbon—from downtown to the Gateway Center district, from Horseshoe Lake to New Poag Road developments. If you're in Glen Carbon, we're already working in your neighborhood.
            </p>
          </div>
        </div>
      </section>
