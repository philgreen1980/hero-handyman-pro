...
export default function DeckRepairBelleville() {
  const seoData = {
    title: "Deck Repair Belleville IL | Board Replacement, Rot Repair & Staining",
    description: "Professional deck repair in Belleville IL — rotted boards, loose railings, structural repairs, and deck staining. Hero Handyman Pro serves all of St. Clair County.",
    keywords: "deck repair Belleville IL, deck board replacement Belleville, deck rot repair Belleville, deck staining Belleville IL, porch repair Belleville",
