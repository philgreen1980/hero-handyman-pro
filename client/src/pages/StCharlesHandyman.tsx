...
export default function StCharlesHandyman() {
  ...
  const faqs = [
    {
      q: "Do you provide free estimates in St. Charles?",
    ...
    },
    {
      ...
      a: "We frequently have same-day or next-day availability in St. Charles. Contact us and we'll confirm our earliest opening."
    },
    {
    ...
    <div className="flex flex-col">
        ...
        <div className="max-w-[1120px] mx-auto">
          <div className="text-center mb-8">
            <h1 className="text-4xl md:text-5xl lg:text-[3.75rem] font-bold leading-tight mb-4">
              Handyman Services in St. Charles, MO
            </h1>
            <p className="text-[#ff5b00] text-xl md:text-2xl font-semibold mb-6">
              Professional, Reliable Home Repairs for St. Charles Homeowners
            </p>
            <p className="text-[#e5e7eb] text-lg md:text-xl max-w-3xl mx-auto mb-8">
              Hero Handyman is your trusted local handyman serving St. Charles, MO. From quick repairs to comprehensive home improvement projects, we deliver professional craftsmanship, transparent pricing, and dependable service every time.
            </p>
          </div>
        ...
        <div className="max-w-[1120px] mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#0b1220]">
              Why St. Charles Homeowners Choose Hero Handyman
            </h2>
            <p className="text-[#4b5563] text-lg max-w-3xl mx-auto">
              Hero Handyman Pro is built on trust, professionalism, and quality workmanship. St. Charles homeowners choose us because we show up on time, communicate clearly, and treat every home with the care and respect it deserves.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-[#ff5b00] to-[#f97316] rounded-2xl p-8 text-white">
            <p className="text-lg leading-relaxed">
              We proudly serve neighborhoods throughout St. Charles—from downtown to the Gateway Center district, from Horseshoe Lake to New Poag Road developments. If you're in St. Charles, we're already working in your neighborhood.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 bg-[#f9fafb]">
        <div className="max-w-[1120px] mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#0b1220]">
              Popular Handyman Services in St. Charles, MO
            </h2>
            <p className="text-[#4b5563] text-lg">
              Here are the most common projects St. Charles homeowners trust us with:
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-[#e5e7eb]">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3 text-[#374151]">
                  ...
                  <span><Link href="/deck-repair-st-charles-mo" className="text-[#ff5b00] hover:underline">Deck repair</Link> and board replacement</span>
                </li>
                <li className="flex items-start gap-3 text-[#374151]">
                  <Check className="h-5 w-5 text-[#ff5b00] mt-0.5 flex-shrink-0" />
                ...
                <li className="flex items-start gap-3 text-[#374151]">
                  <Check className="h-5 w-5 text-[#ff5b00] mt-0.5 flex-shrink-0" />
                  <span><Link href="/carpentry-services-st-charles-mo" className="text-[#ff5b00] hover:underline">Wood rot repair</Link> and exterior trim replacement</span>
                </li>
                <li className="flex items-start gap-3 text-[#374151]">
                  <Check className="h-5 w-5 text-[#ff5b00] mt-0.5 flex-shrink-0" />
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-[#e5e7eb]">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3 text-[#374151]">
                  <Check className="h-5 w-5 text-[#ff5b00] mt-0.5 flex-shrink-0" />
                  <span><Link href="/door-repair-st-charles-mo" className="text-[#ff5b00] hover:underline">Entry door installation</Link> and replacement</span>
                </li>
                <li className="flex items-start gap-3 text-[#374151]">
                  <Check className="h-5 w-5 text-[#ff5b00] mt-0.5 flex-shrink-0" />
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-[#e5e7eb]">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3 text-[#374151]">
                  <Check className="h-5 w-5 text-[#ff5b00] mt-0.5 flex-shrink-0" />
                  <span><Link href="/drywall-repair-st-charles-mo" className="text-[#ff5b00] hover:underline">Drywall crack and hole repair</Link></span>
                </li>
                <li className="flex items-start gap-3 text-[#374151]">
                  <Check className="h-5 w-5 text-[#ff5b00] mt-0.5 flex-shrink-0" />
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-[1120px] mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#0b1220]">
              Proudly Serving St. Charles and Surrounding Communities
            </h2>
            <p className="text-[#4b5563] text-lg max-w-3xl mx-auto">
              Whether you're in downtown St. Charles, near the Gateway Center, or in one of the area's growing neighborhoods, Hero Handyman is ready to help with fast, professional home repair services.
            </p>
          </div>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-[1120px] mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#0b1220]">
              What St. Charles Homeowners Are Saying
            </h2>
          </div>
      ...
      <section className="py-16 px-6 bg-gray-50">
        <div className="max-w-[1120px] mx-auto">
          <h2 className="text-3xl font-bold text-gray-900 mb-3">Specialized Handyman Services in St. Charles, MO</h2>
          <p className="text-gray-600 mb-8 max-w-2xl">Beyond general handyman work, we offer dedicated service pages for St. Charles County's most common repair needs — each with local expertise and same-day availability.</p>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { title: "Drywall Repair", desc: "Hole patching, water damage, ceiling repair, and texture matching for St. Charles homes.", href: "/drywall-repair-st-charles-mo" },
              { title: "Deck Repair", desc: "Board replacement, railing repair, structural repairs, and deck maintenance in St. Charles.", href: "/deck-repair-st-charles-mo" },
              { title: "Door Repair", desc: "Sticking doors, broken hardware, frame repair, and weatherstripping in St. Charles.", href: "/door-repair-st-charles-mo" },
              { title: "Door Installation", desc: "Entry doors, interior doors, storm doors, and patio door installation in St. Charles.", href: "/door-installation-st-charles-mo" },
              { title: "Carpentry Services", desc: "Trim installation, wood rot repair, exterior carpentry, and finish work in St. Charles.", href: "/carpentry-services-st-charles-mo" }
            ].map((service, i) => (
      ...
      <section className="py-16 px-6 bg-gradient-to-br from-[#1f2937] via-[#020617] to-[#020617] text-white">
        <div className="max-w-[1120px] mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Ready to Schedule Handyman Service in St. Charles, MO?
          </h2>
