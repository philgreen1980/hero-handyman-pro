  ...
  const seo = useSeoRoute();  return (
    <div className="flex flex-col">
        ...
        <div className="max-w-[1120px] mx-auto">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mt-2 mb-4 leading-tight">
              Door Repair Services in Ballwin MO
            </h1>
            <p className="text-gray-300 text-lg mb-8">
              Sticking doors, broken latches, damaged frames, and drafty exterior doors — repaired correctly the first time. Serving Ballwin and West St. Louis County homeowners with fast, reliable door repair.
            </p>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-[1120px] mx-auto">
          <h2 className="text-3xl font-bold mb-3 text-gray-900">Door Repair Services in Ballwin</h2>
          <p className="text-gray-600 mb-10 max-w-2xl">
            Ballwin's seasonal temperature swings — from below-zero winters to 95°F summers — cause door frames to expand, contract, and shift. The result is doors that stick in summer, gap in winter, and gradually fall out of alignment. We repair all types of doors for Ballwin homeowners.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="border border-gray-200 rounded-2xl p-7 shadow-sm">
              ...
              <p className="text-gray-600 mb-4">
                Bedroom, bathroom, and closet doors that stick, bind, or won't latch are the most common door repair call in Ballwin. We adjust hinges, plane sticking edges, repair or replace latches and strike plates, and re-hang doors that have shifted out of alignment.
              </p>
              <p className="text-gray-600 text-sm">
                Many Ballwin homes built in the 1980s–1990s have solid-core doors that have shifted as the framing has settled. A hinge adjustment or strike plate repositioning is usually all it takes.
              </p>
            </div>
            ...
            <div className="border border-gray-200 rounded-2xl p-7 shadow-sm">
              ...
              <p className="text-gray-600 mb-4">
                Exterior doors that don't seal properly cost Ballwin homeowners in heating and cooling bills every month. We repair weatherstripping, adjust thresholds, fix sticking or dragging, and address alignment issues that allow drafts or moisture infiltration.
              </p>
              <p className="text-gray-600 text-sm">
                Ballwin's freeze-thaw cycles are particularly hard on exterior door frames. We account for seasonal movement during repairs so your door operates correctly year-round.
              </p>
            </div>
            ...
            <div className="border border-gray-200 rounded-2xl p-7 shadow-sm">
              ...
              <p className="text-gray-600 text-sm">
                A properly functioning storm door adds meaningful insulation value in Ballwin's cold winters. If your storm door is beyond repair, we handle full replacement too.
              </p>
            </div>
            ...
            <div className="border border-gray-200 rounded-2xl p-7 shadow-sm">
              ...
              <p className="text-gray-600 text-sm">
                Foundation settling is common in Ballwin's clay-heavy soils, particularly in older neighborhoods near Kehrs Mill Road. We assess the full scope before recommending a repair approach.
              </p>
            </div>
      ...
      <section className="py-16 px-6 bg-teal-700 text-white">
        <div className="max-w-[1120px] mx-auto text-center">
          <h2 className="text-3xl font-bold mb-3">Need Door Repair in Ballwin MO?</h2>
          <p className="text-teal-100 text-lg mb-8 max-w-2xl mx-auto">
            Same-day and next-day appointments available. Call Hero Handyman Pro at 800-741-6056 for door repair in Ballwin — we'll assess the problem and give you an honest, upfront quote.
          </p>
