...
export default function DrywallRepairBelleville() {
  const seoData = {
    ...
    description: "Professional drywall repair in Belleville IL including hole patching, ceiling drywall repair, and water-damaged drywall fixes. Call Hero Handyman Pro today.",
    keywords: "drywall repair Belleville IL, drywall patching Belleville, ceiling repair Belleville IL, water damaged drywall Belleville, hole in drywall Belleville IL",
