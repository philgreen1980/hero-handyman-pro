      ...
      <section className="py-12 px-6 bg-[#f9fafb] border-b border-gray-200">
        <div className="max-w-[1120px] mx-auto">
          <p className="text-lg text-gray-700 leading-relaxed max-w-4xl">
            Metro East Illinois is tough on fences. Humid summers, heavy spring rains, and freeze-thaw cycles in winter accelerate post rot and board warping — especially in older neighborhoods where fences have been standing for 15+ years. From established subdivisions in <Link href="/gbp/ofallon-il/" className="text-[#ff5b00] hover:underline font-medium">O'Fallon</Link> and <Link href="/gbp/edwardsville-il/" className="text-[#ff5b00] hover:underline font-medium">Edwardsville</Link> to older homes near downtown <Link href="/handyman-belleville-il" className="text-[#ff5b00] hover:underline font-medium">Belleville</Link> and <Link href="/service-areas/collinsville-handyman-services/" className="text-[#ff5b00] hover:underline font-medium">Collinsville</Link>, we see the same pattern: one or two bad posts cause the whole fence line to lean, boards start pulling away, and the gate stops latching. Most of these problems are repairable without replacing the entire fence.
          </p>
        </div>
      </section>
