...
export default function WindowInstallationOFallon() {
  return (
    <div className="min-h-screen">
      <SEO {...seoConfig.windowInstallationOFallon} />
