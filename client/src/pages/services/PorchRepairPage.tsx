  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Professional Porch Repair & Restoration
            </h1>
      ...
      <section className="py-16 bg-white">
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Porch Repair by Location</h2>
            <p className="text-xl text-gray-600 mb-12">
              Get location-specific porch repair information for your community. Each page includes local pricing, neighborhood details, and service area maps.
            </p>
            
            <div className="grid md:grid-cols-2 gap-6">
              <Link 
                href="/services/porch-repair-ofallon-il"
              ...
              >
                ...
                <p className="text-gray-600 text-left">
                  Expert porch repair for O'Fallon homes. Serving all neighborhoods near Scott Air Force Base and downtown O'Fallon.
                </p>
              </Link>
              
              <Link 
                href="/services/porch-repair-edwardsville-il"
                className="group bg-gray-50 hover:bg-teal-50 border-2 border-gray-200 hover:border-teal-600 rounded-lg p-6 transition-all"
              >
                <div className="flex items-center justify-between mb-3">
                ...
                <p className="text-gray-600 text-left">
                  Professional porch repair in Edwardsville. Trusted by homeowners near SIUE campus and throughout the community.
                </p>
              </Link>
              
              <Link 
                href="/services/porch-repair-belleville-il"
                className="group bg-gray-50 hover:bg-teal-50 border-2 border-gray-200 hover:border-teal-600 rounded-lg p-6 transition-all"
              >
                <div className="flex items-center justify-between mb-3">
                ...
                <p className="text-gray-600 text-left">
                  Expert porch repair in Belleville. Serving West Belleville, Signal Hill, and all Belleville neighborhoods.
                </p>
              </Link>
              
              <Link 
                href="/services/porch-repair-collinsville-il"
                className="group bg-gray-50 hover:bg-teal-50 border-2 border-gray-200 hover:border-teal-600 rounded-lg p-6 transition-all"
              >
                <div className="flex items-center justify-between mb-3">
                ...
                <p className="text-gray-600 text-left">
                  Professional porch repair in Collinsville. Trusted service for Maryville, Caseyville, and surrounding areas.
                </p>
              </Link>
            </div>
          </div>
