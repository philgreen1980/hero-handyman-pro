        ...
        <div className="container">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none mb-12">
              ...
              <p>
                We've been installing energy-efficient replacement windows in Belleville neighborhoods like West Belleville, Signal Hill, and Belleville Square for over 35 years. Our team knows the local building codes, understands the architectural styles common in Belleville homes, and can recommend the best window solutions for your specific needs and budget.
              </p>
