...
export default function WindowInstallationBelleville() {
  return (
    <div className="min-h-screen">
      <SEO {...seoConfig.windowInstallationBelleville} />
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-sm font-medium">Proudly Serving Belleville, IL</span>
            </div>
            
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Window Installation in Belleville, IL
            </h1>
            
            <p className="text-xl md:text-2xl mb-8 text-teal-50">
              Local, trusted window installation for Belleville homeowners. Energy-efficient windows that reduce utility bills and boost home value. Same-day estimates available.
            </p>
      ...
      <section className="py-16 bg-white">
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-center">Why Belleville Homeowners Choose Us</h2>
            
            <div className="prose prose-lg max-w-none mb-12">
              <p>
                As a locally-owned business serving Belleville, IL and the surrounding Metro East area, we understand the unique needs of homeowners in our community. Belleville's climate—with hot, humid summers and cold winters—puts extra stress on your windows. Old, drafty windows can account for up to 30% of your home's energy loss, making your HVAC system work overtime.
              </p>
              
              <p>
                We've been installing energy-efficient replacement windows in Belleville neighborhoods like West Belleville, Signal Hill, and Belleville Square for over 30 years. Our team knows the local building codes, understands the architectural styles common in Belleville homes, and can recommend the best window solutions for your specific needs and budget.
              </p>
              
              <p>
                Whether you live near downtown Belleville, along Route 159, or in the historic neighborhoods, we provide fast, professional window installation with transparent pricing and a satisfaction guarantee.
              </p>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center">Window Installation Pricing for Belleville Homes</h2>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
              <p className="text-sm">
                <strong>Free estimates for Belleville residents.</strong> Prices include removal of old windows, installation, insulation, trim work, and cleanup. Same-day service available for urgent needs.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Ready to Upgrade Your Belleville Home's Windows?
            </h2>
            <p className="text-xl mb-8 text-teal-50">
              Call today for a free, no-obligation estimate. We serve all Belleville neighborhoods and surrounding areas.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" variant="default" className="bg-orange-500 hover:bg-orange-600 text-white" asChild>
                <Link href="/#contact">
      ...
      <section className="py-16 bg-white">
        <div className="container">
          <ServiceAreaMap 
            center={{ lat: 38.5200, lng: -89.9840 }}
            radiusMiles={10}
            locationName="Belleville, IL"
          />
        </div>
      </section>
      ...
      <ServiceSchema 
        ...
        description="Professional window installation services in Belleville, IL. Energy-efficient replacement windows for local homeowners."
        serviceType="Window Installation"
        areaServed="Belleville, IL"
        priceRange="$300-$1500"
        pageUrl="/services/window-installation-belleville-il"
      />
    </div>
  );
}
