  ...
  return (
    <div className="flex flex-col">
        ...
        <div className="max-w-[1120px] mx-auto">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mt-2 mb-4 leading-tight">
              Door Repair & Installation in Collinsville IL
            </h1>
            <p className="text-gray-300 text-lg mb-8">
              Sticking doors, broken frames, drafty entry doors, and hardware that won't latch — all fixed by experienced craftsmen. We serve Collinsville and the surrounding Madison County communities.
            </p>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-[1120px] mx-auto">
          <h2 className="text-3xl font-bold mb-3 text-gray-900">Door Repair & Installation Services in Collinsville</h2>
          <p className="text-gray-600 mb-10 max-w-2xl">
            Collinsville's housing stock spans from post-war bungalows near downtown to 1970s–1990s ranch homes and newer subdivisions off Beltline Road. Older homes often have doors that have settled with the foundation, while newer homes deal with worn hardware and weatherstripping. Madison County's humid summers cause wood frames to swell — making sticking doors one of the most common repair calls we receive.
          </p>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: "Interior Door Repair", desc: "Doors that stick, won't latch, or have sagging hinges repaired and adjusted. We plane, shim, and re-hang for a smooth swing every time." },
              { title: "Exterior & Entry Door Replacement", desc: "Drafty, damaged, or outdated entry doors replaced with properly fitted units. Includes frame repair and weatherstripping for a tight seal." },
              { title: "Storm Door Installation", desc: "Storm doors add insulation and protect your entry door from Collinsville's weather. We install and adjust for a tight, draft-free fit." },
              { title: "Door Frame Repair", desc: "Rotted or damaged door frames repaired or replaced. Common in Collinsville's older homes where moisture has worked into wood frames over decades." },
              { title: "Sliding & Patio Door Repair", desc: "Sliding doors that jump the track, won't lock, or have worn rollers repaired. We also replace broken glass panels and adjust for smooth operation." },
              { title: "Hardware & Lockset Installation", desc: "Deadbolts, knobs, levers, and smart locks installed or replaced. We ensure proper alignment so hardware functions smoothly and securely." }
            ].map((service, i) => (
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Not every door problem requires a full replacement. Many Collinsville homeowners are surprised to learn that a sticking door can be fixed in under an hour, or that a drafty door just needs new weatherstripping rather than a new unit.
              </p>
              <p className="text-gray-600 mb-4">
                We give you an honest assessment. If a repair will solve the problem for years, we'll say so. If the door or frame is too far gone and replacement is the better value, we'll tell you that too — with a clear cost comparison before any work begins.
              </p>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-[1120px] mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { title: "Honest Assessment", desc: "We tell you whether repair or replacement is the better value — no upselling, no pressure." },
        ...
        <div className="max-w-[1120px] mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-teal-100 mb-4">
              We repair and install doors throughout Collinsville — from the older homes near downtown and Maryville Road to newer subdivisions off Beltline Road and IL-157. Collinsville's mix of housing eras means we regularly work on everything from 1950s bungalows with non-standard door openings to newer homes with modern prehung units that just need proper adjustment.
            </p>
        ...
        <div className="max-w-[1120px] mx-auto">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/door-repair-edwardsville-il">
              <Button variant="outline" className="rounded-full border-gray-300 hover:border-teal-500 hover:text-teal-600">Door Repair in Edwardsville</Button>
            </Link>
            <Link href="/door-repair-ofallon-il">
              <Button variant="outline" className="rounded-full border-gray-300 hover:border-teal-500 hover:text-teal-600">Door Repair in O'Fallon</Button>
            </Link>
          </div>
        </div>
      </section>
