...
export default function DoorInstallationCollinsville() {
  const seoData = {
    ...
    description: "Professional door installation in Collinsville IL — entry doors, interior doors, storm doors, and patio doors. Hero Handyman Pro serves all of Madison County.",
    keywords: "door installation Collinsville IL, entry door installation Collinsville, interior door installation Collinsville IL, storm door installation Collinsville, patio door installation Collinsville IL",
