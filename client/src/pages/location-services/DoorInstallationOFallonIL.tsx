...
export default function DoorInstallationOFallonIL() {
  const seoData = {
    title: "Door Installation O'Fallon IL | Local Experts | Same-Day Quotes",
    description: "Professional door installation in O'Fallon, IL. Local, trusted service. Licensed & insured. Same-day quotes. Call 618-353-0955 for free estimate.",
    keywords: "door installation O'Fallon IL, door installation O'Fallon, O'Fallon door installation",
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container max-w-5xl mx-auto">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
              Door Installation in O'Fallon, IL
            </h1>
            <p className="text-xl text-teal-50 mb-8">
              Your local door installation experts in O'Fallon. Professional service with expert craftsmanship and attention to detail.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/booking/">
                <Button 
                  ...
                  onClick={() => trackCTAClick('Get Free Quote', 'Door Installation O\'Fallon - Hero CTA')}
                >
                  Get Free Quote
                </Button>
              </Link>
              <a href="tel:618-353-0955" onClick={() => trackPhoneClick('618-353-0955', 'Door Installation O\'Fallon Hero')}>
      ...
      <section className="py-16 px-6 bg-gradient-to-br from-teal-700 to-teal-900 text-white">
        <div className="container max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-teal-50 mb-8">
            Get a free quote for professional door installation in O'Fallon, IL. Same-day estimates available.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/booking/">
              <Button 
                size="lg" 
                className="bg-orange-500 hover:bg-orange-600 text-white rounded-full px-8"
                onClick={() => trackCTAClick('Get Free Quote', 'Door Installation O\'Fallon - Bottom CTA')}
              >
                Get Free Quote
              </Button>
            </Link>
            <a href="tel:618-353-0955" onClick={() => trackPhoneClick('618-353-0955', 'Door Installation O\'Fallon Bottom')}>
              <Button size="lg" variant="outline" className="border-2 border-white text-white hover:bg-white hover:text-teal-800 rounded-full px-8">
                <Phone className="w-5 h-5 mr-2" />
                Call: 618-353-0955
              </Button>
