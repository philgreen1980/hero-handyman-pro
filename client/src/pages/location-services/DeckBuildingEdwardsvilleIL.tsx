...
export default function DeckBuildingEdwardsvilleIL() {
  const seoData = {
    ...
    keywords: "deck building Edwardsville IL, deck building Edwardsville, Edwardsville deck building",
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container max-w-5xl mx-auto">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-teal-50 mb-8">
              Your local deck building experts in Edwardsville. Professional service with expert craftsmanship and attention to detail.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a href="tel:618-353-0955" onClick={() => trackPhoneClick('618-353-0955', 'Deck Building Edwardsville Hero')}>
      ...
      <section className="py-16 px-6 bg-gradient-to-br from-teal-700 to-teal-900 text-white">
        <div className="container max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-teal-50 mb-8">
            Get a free quote for professional deck building in Edwardsville, IL. Same-day estimates available.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/booking/">
              <Button 
            ...
            <a href="tel:618-353-0955" onClick={() => trackPhoneClick('618-353-0955', 'Deck Building Edwardsville Bottom')}>
              <Button size="lg" variant="outline" className="border-2 border-white text-white hover:bg-white hover:text-teal-800 rounded-full px-8">
                <Phone className="w-5 h-5 mr-2" />
                Call: 618-353-0955
              </Button>
