    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container max-w-5xl mx-auto">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-sm font-medium">Serving St. Louis, MO & Surrounding Areas</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
              Deck Repair in St. Louis, MO
            </h1>
            <p className="text-xl text-teal-50 mb-8">
              Your local deck repair experts in St. Louis. Professional service with expert craftsmanship and attention to detail.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/booking/">
                <Button 
                  ...
                  onClick={() => trackCTAClick('Get Free Quote', 'Deck Repair St\. Louis - Hero CTA')}
                >
                  Get Free Quote
                </Button>
              </Link>
              <a href="tel:314-499-5522" onClick={() => trackPhoneClick('314-499-5522', 'Deck Repair St\. Louis Hero')}>
        ...
        <div className="container max-w-5xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div>
              ...
              <div className="font-semibold text-gray-900">Local St. Louis Team</div>
      ...
      <section className="py-16 px-6 bg-gradient-to-br from-teal-700 to-teal-900 text-white">
        <div className="container max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-teal-50 mb-8">
            Get a free quote for professional deck repair in St. Louis, MO. Same-day estimates available.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/booking/">
              <Button 
                size="lg" 
                className="bg-orange-500 hover:bg-orange-600 text-white rounded-full px-8"
                onClick={() => trackCTAClick('Get Free Quote', 'Deck Repair St\. Louis - Bottom CTA')}
              >
                Get Free Quote
              </Button>
            </Link>
            <a href="tel:314-499-5522" onClick={() => trackPhoneClick('314-499-5522', 'Deck Repair St\. Louis Bottom')}>
              <Button size="lg" variant="outline" className="border-2 border-white text-white hover:bg-white hover:text-teal-800 rounded-full px-8">
                <Phone className="w-5 h-5 mr-2" />
                Call: 314-499-5522
              </Button>
