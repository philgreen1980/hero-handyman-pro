    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container max-w-5xl mx-auto">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
              Door Installation in Edwardsville, IL
            </h1>
            <p className="text-xl text-teal-50 mb-8">
              Your local door installation experts in Edwardsville. Professional service with expert craftsmanship and attention to detail.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/booking/">
                <Button 
                  ...
                  onClick={() => trackCTAClick('Get Free Quote', 'Door Installation Edwardsville - Hero CTA')}
                >
                  Get Free Quote
                </Button>
              </Link>
              <a href="tel:618-353-0955" onClick={() => trackPhoneClick('618-353-0955', 'Door Installation Edwardsville Hero')}>
      ...
      <section className="py-16 px-6 bg-gradient-to-br from-teal-700 to-teal-900 text-white">
        <div className="container max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-teal-50 mb-8">
            Get a free quote for professional door installation in Edwardsville, IL. Same-day estimates available.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/booking/">
              <Button 
                size="lg" 
                className="bg-orange-500 hover:bg-orange-600 text-white rounded-full px-8"
                onClick={() => trackCTAClick('Get Free Quote', 'Door Installation Edwardsville - Bottom CTA')}
              >
                Get Free Quote
              </Button>
            </Link>
            <a href="tel:618-353-0955" onClick={() => trackPhoneClick('618-353-0955', 'Door Installation Edwardsville Bottom')}>
              <Button size="lg" variant="outline" className="border-2 border-white text-white hover:bg-white hover:text-teal-800 rounded-full px-8">
                <Phone className="w-5 h-5 mr-2" />
                Call: 618-353-0955
              </Button>
