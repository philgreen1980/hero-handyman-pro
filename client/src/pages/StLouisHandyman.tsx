...
export default function StLouisHandyman() {
  ...
  const neighborhoods = [
    ...
    "Tower Grove and Shaw neighborhoods",
    "The Hill",
    "South City communities",
    "Dogtown and Clayton-Tamm",
    "Benton Park and Cherokee Street area"
  ];
  ...
  const faqs = [
    {
      q: "Do you provide free estimates in St. Louis?",
      a: "Yes, we provide clear, detailed estimates at no charge. Many projects can be estimated from photos, and we're happy to schedule an in-home consultation for larger or more complex work."
    },
    {
      q: "How soon can you start my project?",
      a: "We frequently have same-day or next-day availability in St. Louis. Contact us and we'll confirm our earliest opening."
    },
    {
